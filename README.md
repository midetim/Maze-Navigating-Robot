...
Once the destination is reached, the learned path is reused to return without errors.

Sensors & Control

Differential light sensors for continuous line following

Absolute light sensors for intersection detection

Bumper sensors for obstacle and dead-end feedback

Finite state machine controls exploration, correction, and retracing

All logic is implemented at the bare-metal level, without high-level libraries.
